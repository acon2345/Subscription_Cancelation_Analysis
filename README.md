...
* 36.4% of users reported "Not Useful" as the primary cancelation reason. The top choices for the primary reason were "Not Useful" and "Expensive".
* Over time, we see a large growth in number of cancelations from 2023 to 2024.
